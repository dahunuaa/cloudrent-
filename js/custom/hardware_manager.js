...
app.controller('myCtrl', function($scope,$http) {
    var get_url  ="api/v1.0/admin/products/hardware?";//get数据接口
    var del_url  ="api/v1.0/admin/products/hardware";//删除接口
    var add_url  ="hardware_add.html";//点击新增跳转地址
    ...
    function init(){
        if(localStorage.getItem("token") == undefined ||localStorage.getItem("token") == null){
            ...
            myGrid.setHeader("选择,城市,名称,价格,封面,操作");//设置表头
            myGrid.attachHeader("#master_checkbox," +
                ...
                "," +
                "&nbsp;");
            myGrid.setInitWidths("100,100,100,100,*,200");//设置表格初始宽度
                ...
                if(res.response.success == 1){
                    ...
                    for(var i=0; i < get_data.length;i++){
                        ...
                        myGrid.addRow(str,[
                            ...
                            "<span style='margin: 0;padding: 0;font-size: 24px' class='icon-ios-trash' id='del'>"
                            //"</span><span style='margin: 0;padding: 0'  class='icon-android-create' id='edit'></span>"
                        ],i);
...
//点击事件-行内修改
    $("table").on('click','#edit',function(){
     window.location.href = "hardware_edit.html?"+$scope.this_row_id
    });
    ...
    $("input:text").bind("input propertychange",function(){
        ...
        $scope.so_price=document.getElementById("parame_c").value;
